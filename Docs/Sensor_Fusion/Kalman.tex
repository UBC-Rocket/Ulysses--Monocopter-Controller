...
$$
\theta_{x|t,t}=\theta_{x|t-1,t-1}+\Delta t\cdot\omega_x
$$
We expect the initial values of $\theta$ to be 0. We otherwise have no point of reference to begin our calculations.
However, the gyroscope reports a noise 
\end{document}