...
#define GPS_INT_EXTI_IRQn EXTI2_IRQn
...
#define BMI_ACC_INT1_EXTI_IRQn EXTI8_IRQn
...
#define BMI_GYRO_INT1_EXTI_IRQn EXTI10_IRQn
...
#define BNO_INT_EXTI_IRQn EXTI13_IRQn
