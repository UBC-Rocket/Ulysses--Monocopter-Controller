...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : User_Button_Pin BMI_ACC_INT2_Pin BMI_GYRO_INT2_Pin */
  GPIO_InitStruct.Pin = User_Button_Pin|BMI_ACC_INT2_Pin|BMI_GYRO_INT2_Pin;
  ...
  /*Configure GPIO pins : BMI_ACC_INT1_Pin BMI_GYRO_INT1_Pin */
  GPIO_InitStruct.Pin = BMI_ACC_INT1_Pin|BMI_GYRO_INT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
